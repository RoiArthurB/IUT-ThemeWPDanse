...
function dance_dancer_type() {
	...
	$labels = array(
		...
		'archives'              => __( 'Item Archives', 'dance' ),
		...
		'insert_into_item'      => __( 'Insert into item', 'dance' ),
		'uploaded_to_this_item' => __( 'Uploaded to this item', 'dance' ),
		'items_list'            => __( 'Items list', 'dance' ),
		'items_list_navigation' => __( 'Items list navigation', 'dance' ),
		'filter_items_list'     => __( 'Filter items list', 'dance' ),
	);
	$args = array(
